...
This downloads only:
- **AD:** GSE28146 (~30 samples, smaller file)
- **OA:** GSE55235 (~20 samples, smaller file)
...
- Real biological data has more complexity (batch effects, technical variation)
- Results should be validated with actual experimental data
